...
include { GUNZIP as GUNZIP_FASTA }            from '../../modules/nf-core/gunzip/main.nf'                         //addParams(options: params.genome_options)
include { GUNZIP as GUNZIP_GENE_BED }         from '../../modules/nf-core/gunzip/main.nf'                         //addParams(options: params.genome_options)
include { GUNZIP as GUNZIP_GFF }              from '../../modules/nf-core/gunzip/main.nf'                         //addParams(options: parms.genome_options)
include { GUNZIP as GUNZIP_GTF }              from '../../modules/nf-core/gunzip/main.nf'                         //addParams(options: params.genome_options)
include { SAMTOOLS_FAIDX }                    from '../../modules/nf-core/samtools/faidx/main.nf'                 //addParams(options: params.genome_options)
...
workflow PREPARE_GENOME {
    ...
    if (params.dict) {
	ch_fasta_dict = Channel.fromPath(params.dict).collect()
	} else {
