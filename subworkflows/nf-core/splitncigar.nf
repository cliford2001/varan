...
workflow SPLITNCIGAR {
	...
	bam_interval = bam.combine(intervals)

	// Extraer y reensamblar los elementos
	bam_intervals = bam_interval.map { bam_data, bam_file1, bam_file2, intervals_data, intervals_file ->
